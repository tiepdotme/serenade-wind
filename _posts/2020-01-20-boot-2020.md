...
{% assign pwcaption="Photo by Boot" %}
{% assign pwpng="" %}
...
{% assign pwcaption="Photo by Berthon USA." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Hallberg-Rassy 57. Photo by Sailing Today." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Najad 395AC. Photo by Najad." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Sirius 40 DS. Photo by Sirius Werft." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Galley aboard Sirius 40. Photo by Sirius Werft." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Sirius 40 DS Cockpit features a pivoting helm station. Photo by Sirius Werft." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Sirius 40DS salon, galley, nav station. Photo by Sirius Werft." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
...
{% assign pwcaption="Sirius 40DS Owner's cabin located mid-ship. Photo by Sirius Werft." %}
{% assign pwpng="" %}
{% include post-wide-image.html%}
